...
def dependencies():
    ...
    go_repository(
        ...
        sum = "h1:EyUnxyP2yaGpLgMiuyyz8sHnByqeTJUfGs72pdH0i4A=",
        version = "v0.3.2",
    )
    go_repository(
    ...
    go_repository(
        name = "com_github_go_playground_form",
        importpath = "github.com/go-playground/form",
        sum = "h1:lvKiHVxE2WvzDIoyMnWcjyiBxKt2+uFJyZcPYWsLnjI=",
        version = "v3.1.4+incompatible",
    )
    go_repository(
    ...
    go_repository(
        name = "com_github_mbobakov_grpc_consul_resolver",
        importpath = "github.com/mbobakov/grpc-consul-resolver",
        sum = "h1:jnwggRTBeSg8QtAc1cQcFUmBo6FGPSWOV3LTxU1Bhgc=",
        version = "v1.4.3",
    )
    go_repository(
